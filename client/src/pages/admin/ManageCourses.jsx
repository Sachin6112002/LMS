...
const ManageCourses = () => {
    const [courses, setCourses] = useState([
        { id: 1, title: 'React Basics', instructor: 'John Doe', price: 100, enrolledStudents: 120, status: 'Published', rating: 4.5, createdAt: '2025-01-01' },
        { id: 2, title: 'Advanced JavaScript', instructor: 'Jane Smith', price: 150, enrolledStudents: 80, status: 'Unpublished', rating: 4.0, createdAt: '2025-02-15' },
        { id: 3, title: 'UI/UX Design', instructor: 'Alice Johnson', price: 200, enrolledStudents: 50, status: 'Published', rating: 4.8, createdAt: '2025-03-10' },
    ]);
