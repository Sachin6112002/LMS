    ...
    <>
      <div className="flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
        ...
        <div className="max-w-xl z-10 text-gray-500">
          <h1 className="md:text-cousre-details-heading-large text-cousre-details-heading-small font-semibold text-gray-800">
          ...
          <p className="text-sm">
            Course by <span className="text-blue-600">sachin Kaintura</span>
          </p>
          <div className="pt-8 text-gray-800">
            ...
            <div className="pt-5">
              {courseData.courseContent.map((chapter, index) => (
                <div
                  key={index}
                  className="border border-x-gray-300 bg-white mb-2 rounded "
                >
                  <div
                  ...
                  >
                    <ul className="list-disc ma:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-green-300">
        ...
        { playerData ? <YouTube videoId= {playerData.videoId} opts={{playerVars : {
                  autoplay : 1
                }}} iframeClassName="w-full aspect-ratio"></YouTube> :  <img src={courseData.courseThumbnail} alt="" /> }
