    ...
    <div className="h-screen overflow-scroll flex flex-col items-center md:p-8 p-4 bg-green-50">
      ...
      <div className="w-full max-w-2xl mb-8">
        <div className="flex items-center justify-between text-green-900 text-lg font-semibold">
          <div className={`flex-1 text-center ${!createdCourse ? 'text-green-700 font-bold' : 'text-green-400'}`}>1. Create Course</div>
          <div className="flex-1 text-center">→</div>
          <div className={`flex-1 text-center ${createdCourse && chapters.length === 0 ? 'text-green-700 font-bold' : 'text-green-400'}`}>2. Add Chapters</div>
          <div className="flex-1 text-center">→</div>
          <div className={`flex-1 text-center ${createdCourse && chapters.length > 0 ? 'text-green-700 font-bold' : 'text-green-400'}`}>3. Add Lectures</div>
        </div>
      </div>
