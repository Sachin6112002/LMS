...
const CallToAction = () => {
  return (
    <div className='flex flex-col items-center gap-4 pt-20 pb-24 px-8 md:px-0'>
      ...
      <p className='text-gray-500 sm:text-sm'>Explore limitless learning opportunities with our expert-curated courses. Join today and embark on your journey to success!</p>
